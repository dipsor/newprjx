        ...
        <v-flex xs12>
            <v-card>
                <v-toolbar color="purple darken-3" dark>
                    <v-toolbar-title>Zde vytvořte práci</v-toolbar-title>
                    <v-spacer></v-spacer>
                </v-toolbar>
                <v-container  grid-list-xs>
                    ...
                    <v-layout row wrap v-show="kapsaProCD == true">
                        ...
                        <v-flex xs4 hidden-sm-and-down>
                            <v-slider v-model="selectedData.pocetKapesProCD" thumb-label v-bind:max="5" v-bind:min="0"></v-slider>
                        </v-flex>
                        <v-flex  xs4 md2>
                            <v-text-field
                    ...
                    <v-layout row wrap  v-show="kapsaProPosudek == true">
                        <v-flex xs4></v-flex>
                        <v-flex xs4 hidden-sm-and-down>
                            <v-slider v-model="selectedData.pocetKapesProPosudek" thumb-label v-bind:max="5" v-bind:min="0"></v-slider>
                        </v-flex>
                        <v-flex xs4 md2>
                            <v-text-field
